...
import 'package:demo1/payment_success.dart';
...
class Money_Donation extends StatefulWidget {
  const Money_Donation({Key? key}) : super(key: key);

  @override
  State<Money_Donation> createState() => _Money_DonationState();
}

class _Money_DonationState extends State<Money_Donation> {
  ...
  void money_donation()async {
    ...
    var data = {
      ...
      "money_dateInput": dateInput.text,
    ...
    print("data${data}");
    var res = await Api().authData(data,'/api/money_donation');
            ...
            child: Column(
              children: [
                Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('image/money_donation.jpg')),
                    )
                ),
                ...
                Align(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text('Choose your payment method',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                  ),
                ),
